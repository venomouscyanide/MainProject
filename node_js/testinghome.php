...
<script>  
	...
	var register = registerUser.at('0x44b9bc730a77ccea1728f4e03fd200afd4c0f601');
	...
	if(!exists[1]) //if does not exist then we need to clear all values and make him log in again after closing modal
		...
		{
		console.log(url);	
		var show=register.registerUser(index,$("#name").val(),$("#email").val(),$("#password").val(),$("#age").val(),$("#address").val(),$("#mobile").val(),0,"NULL",url,{gas:300000});
